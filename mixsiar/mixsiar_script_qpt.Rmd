...
```{r}
# To run on your data, replace the system.file call with the path to your file
mix.filename <- file.path("data", "qpt_consumer.csv")
...
```{r}
# To run on your data, replace the system.file call with the path to your file
source.filename <- file.path("data", "qpt_sources_nosoil.csv")
...
```{r}
# To run on your data, replace the system.file call with the path to your file
discr.filename <- file.path("data", "qpt_discrimination_nosoil.csv")
...
output_options <- list(summary_save = TRUE,                 
                       summary_name = file.path("output", "summary_statistics"), 
                       sup_post = TRUE,                    
                       plot_post_save_pdf = TRUE,           
                       plot_post_name = file.path("output", "posterior_density"),
                       sup_pairs = TRUE,             
                       plot_pairs_save_pdf = TRUE,    
                       plot_pairs_name = file.path("output", "pairs_plot"),
                       sup_xy = TRUE,           
                       plot_xy_save_pdf = TRUE,
                       plot_xy_name = file.path("output", "xy_plot"),
                       gelman = TRUE,
                       heidel = FALSE,  
                       geweke = TRUE,   
                       diag_save = TRUE,
                       diag_name = file.path("output", "diagnostics"),
                       indiv_effect = FALSE,       
