...
lake_name <- "QPT" # for plots
lake <- "qpt" # for use in code
...
```{r}
# To run on your data, replace the system.file call with the path to your file
source.filename <- file.path("extdata", "qpt_sources_suess.csv")
...
```{r}
# To run on your data, replace the system.file call with the path to your file
discr.filename <- file.path("extdata", "qpt_discrimination.csv")
