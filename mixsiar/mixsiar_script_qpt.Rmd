...
## My plots
```{r}
sum_stats_mod <- read.csv(file.path(my_dir, "summary_statistics_mod.csv")) %>% 
...
```{r}
pdf(file.path(my_dir,"means_area_plot.pdf"),width=8,height=5,paper='special')

pdf(file.path(my_dir,"means_point_plot.pdf"),width=8,height=5,paper='special')
```
