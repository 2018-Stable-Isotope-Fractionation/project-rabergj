...
lake_name <- "SKR" # for plots
lake <- "skr_small" # for use in code

run_length <- "normal"

my_dir <- paste(lake, run_length, "2", sep = "_") # add appendix here if needed
...
dev.off() # This should clear some devices (plots) from memory (?)
