---
title: "Stable Isotope Analysis of Iceland Lake Sediments"
subtitle: "Lake **HVT**"
...
lake_data = read.csv("data/hvt.csv")
lake_data <-
  lake_data %>%
...
isospace <- 
  ...
  labs(
    title = paste("Lake", lake_name, "Isospace", sep = " "), 
    color = "Age (yrs)", 
...
isospace_cn <- 
  ...
  labs(
    title = paste("Lake", lake_name, "Isospace with C:N", sep = " "), 
    color = "Age (yrs)", 
    x = latex2exp::TeX("$\\delta^{13}C$"), 
    y = latex2exp::TeX("$\\C:N$"))
