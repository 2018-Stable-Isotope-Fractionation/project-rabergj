...
best_fit <- optim(c(0.3, 0.3), i = 1, optim_function, method = "BFGS")$value
length(best_fit)
...
optim_results <- 
  ...
  do({
    i <- .$i[1]
    a_optim <- optim(c(0.3, 0.3), i = i, optim_function, method = "BFGS")$par[1]
    t_optim <- optim(c(0.3, 0.3), i = i, optim_function, method = "BFGS")$par[2]
    m_optim <- 1 - a_optim - t_optim
    distance_optim<- optim(c(0.3, 0.3), i = i, optim_function, method = "BFGS")$value
